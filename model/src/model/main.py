...
def main():
    ...
    collect_parser.add_argument(
        "--osm-path", type=str, default=config.DISTRICT_1_OSM, help="Path to file osm"
    )
    collect_parser.add_argument(
        "--net-file", type=str, default=config.DISTRICT_1_NET, help="Path to sumo file"
    )
    collect_parser.add_argument(
        "--map-image-chart",
        type=str,
        default=config.DISTRICT_1_TRAFFIC_CHART,
        help="Path to traffic chart",
    )
